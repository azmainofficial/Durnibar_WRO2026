...
class YoloObjectDetector:
    ...
    def detect_bounding_boxes(self, frame, hsv_cfg):
        ...
        l_r1 = np.array([cr1.get('h_min', 0), cr1.get('s_min', 150), cr1.get('v_min', 100)])
        u_r1 = np.array([cr1.get('h_max', 10), cr1.get('s_max', 255), cr1.get('v_max', 255)])
        l_r2 = np.array([cr2.get('h_min', 170), cr2.get('s_min', 150), cr2.get('v_min', 100)])
        ...
        for color_name, mask in [('green', mask_g), ('red', mask_r)]:
