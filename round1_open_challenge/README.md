# Raspberry Pi 5 – Challenge 1 (Open Challenge) Isolated Subsystem

This folder contains the isolated Raspberry Pi 5 scripts (vision, RPLiDAR C1, optimal path planning, and ESP32 telemetry) for **Challenge 1 (Open Challenge)**.
