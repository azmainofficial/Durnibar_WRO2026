# Raspberry Pi 5 – Challenge 1 (Open Challenge) Discrete Cornering Subsystem

This folder contains the isolated Raspberry Pi 5 scripts configured to perform **Discrete Cornering Navigation** for **Challenge 1 (Open Challenge)**. It drives straight (servo centered at 110) with gentle side safety wall-drift corrections, and snaps to full turns when a corner is detected using absolute heading changes (IMU yaw) for smooth, non-oscillating motion.
