# Raspberry Pi 5 – Challenge 1 (Open Challenge) Odometry Waypoint Subsystem

This folder contains the isolated Raspberry Pi 5 scripts configured to perform **closed-loop Odometry Waypoint Navigation** for **Challenge 1 (Open Challenge)** using $(X, Y)$ coordinate tracking and IMU yaw from the ESP32.
